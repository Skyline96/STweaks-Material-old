...
*/
		...
		controlLayout.setPadding(15, 5, 15, 5);
		
        //TODO: Move this to xml
		//Control name
		nameTextView = new TextView(context);
		//-- nameTextView.setBackgroundColor(Color.BLACK);
		nameTextView.setTextColor(Color.parseColor("#FF009688"));
		...
		descriptionTextView.setPadding(15, 5, 5, 0);
		...
		descriptionTextView.setTextColor(Color.parseColor("#FF263238"));
        ...
        paneSeparatorLine.setBackgroundColor(Color.parseColor("#FF263238"));
