...
import android.graphics.drawable.ColorDrawable;//For ActionBar BG
...
//    	handler.postDelayed(r, 5000);   	
    ...
    private void createSwipableTabs(final ActionBar actionBar) {
        ...
        actionBar.setStackedBackgroundDrawable(new ColorDrawable(Color.parseColor("#FF21272B")));
        ...
        //TextView textViewStart = (TextView) findViewById(R.id.textViewStart);//Tabs Text Color
        //textViewStart.setTextColor(Color.parseColor("#FF263238"));
    ...
    public static class SyhTabFragment extends Fragment {
        ...
        private ScrollView createSyhTab(Integer tabIndex) {
            ...
            if (customView != null) {
                ...
                tabContentLayout.setBackgroundColor(Color.parseColor("#FFFAFAFA"));
